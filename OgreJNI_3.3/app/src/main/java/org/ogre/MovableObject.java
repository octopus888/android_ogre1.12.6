...
public class MovableObject extends ShadowCaster {
  ...
  static public class Listener {
    ...
    public Listener() {
      ...
      OgreJNI.MovableObject_Listener_director_connect(this, swigCPtr, swigCMemOwn, true);
    }
  ...
  public Affine3 _getParentNodeFullTransform() {
    return new Affine3(OgreJNI.MovableObject__getParentNodeFullTransform(swigCPtr, this), false);
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__ShadowRenderable_p_t getShadowVolumeRenderableList(ShadowTechnique shadowTechnique, Light light, HardwareIndexBufferPtr indexBuffer, SWIGTYPE_p_size_t indexBufferUsedSize, boolean extrudeVertices, float extrusionDist, long flags) {
    return new SWIGTYPE_p_std__vectorT_Ogre__ShadowRenderable_p_t(OgreJNI.MovableObject_getShadowVolumeRenderableList__SWIG_0(swigCPtr, this, shadowTechnique.swigValue(), Light.getCPtr(light), light, HardwareIndexBufferPtr.getCPtr(indexBuffer), indexBuffer, SWIGTYPE_p_size_t.getCPtr(indexBufferUsedSize), extrudeVertices, extrusionDist, flags), false);
  }
  ...
  public Entity castEntity() {
    long cPtr = OgreJNI.MovableObject_castEntity(swigCPtr, this);
