...
public class Entity extends MovableObject {
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__MovableObject_p_t getAttachedObjects() {
    return new SWIGTYPE_p_std__vectorT_Ogre__MovableObject_p_t(OgreJNI.Entity_getAttachedObjects(swigCPtr, this), false);
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__ShadowRenderable_p_t getShadowVolumeRenderableList(ShadowTechnique shadowTechnique, Light light, HardwareIndexBufferPtr indexBuffer, SWIGTYPE_p_size_t indexBufferUsedSize, boolean extrudeVertices, float extrusionDistance, long flags) {
    return new SWIGTYPE_p_std__vectorT_Ogre__ShadowRenderable_p_t(OgreJNI.Entity_getShadowVolumeRenderableList__SWIG_0(swigCPtr, this, shadowTechnique.swigValue(), Light.getCPtr(light), light, HardwareIndexBufferPtr.getCPtr(indexBuffer), indexBuffer, SWIGTYPE_p_size_t.getCPtr(indexBufferUsedSize), extrudeVertices, extrusionDistance, flags), false);
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__ShadowRenderable_p_t getShadowVolumeRenderableList(ShadowTechnique shadowTechnique, Light light, HardwareIndexBufferPtr indexBuffer, SWIGTYPE_p_size_t indexBufferUsedSize, boolean extrudeVertices, float extrusionDistance) {
    return new SWIGTYPE_p_std__vectorT_Ogre__ShadowRenderable_p_t(OgreJNI.Entity_getShadowVolumeRenderableList__SWIG_1(swigCPtr, this, shadowTechnique.swigValue(), Light.getCPtr(light), light, HardwareIndexBufferPtr.getCPtr(indexBuffer), indexBuffer, SWIGTYPE_p_size_t.getCPtr(indexBufferUsedSize), extrudeVertices, extrusionDistance), false);
  }
  ...
  public void loadingComplete(Resource res) {
    OgreJNI.Entity_loadingComplete(swigCPtr, this, Resource.getCPtr(res), res);
  }
