...
public class CompositorInstance {
  ...
  static public class TargetOperation {
    ...
    public void setRenderSystemOperations(SWIGTYPE_p_std__vectorT_std__pairT_int_Ogre__CompositorInstance__RenderSystemOperation_p_t_t value) {
      OgreJNI.CompositorInstance_TargetOperation_renderSystemOperations_set(swigCPtr, this, SWIGTYPE_p_std__vectorT_std__pairT_int_Ogre__CompositorInstance__RenderSystemOperation_p_t_t.getCPtr(value));
    }
  
    public SWIGTYPE_p_std__vectorT_std__pairT_int_Ogre__CompositorInstance__RenderSystemOperation_p_t_t getRenderSystemOperations() {
      long cPtr = OgreJNI.CompositorInstance_TargetOperation_renderSystemOperations_get(swigCPtr, this);
      return (cPtr == 0) ? null : new SWIGTYPE_p_std__vectorT_std__pairT_int_Ogre__CompositorInstance__RenderSystemOperation_p_t_t(cPtr, false);
    }
  ...
  public void _compileTargetOperations(SWIGTYPE_p_std__vectorT_Ogre__CompositorInstance__TargetOperation_t compiledState) {
    OgreJNI.CompositorInstance__compileTargetOperations(swigCPtr, this, SWIGTYPE_p_std__vectorT_Ogre__CompositorInstance__TargetOperation_t.getCPtr(compiledState));
  }
  ...
  public void addListener(SWIGTYPE_p_Ogre__CompositorInstance__Listener l) {
    OgreJNI.CompositorInstance_addListener(swigCPtr, this, SWIGTYPE_p_Ogre__CompositorInstance__Listener.getCPtr(l));
  }

  public void removeListener(SWIGTYPE_p_Ogre__CompositorInstance__Listener l) {
    OgreJNI.CompositorInstance_removeListener(swigCPtr, this, SWIGTYPE_p_Ogre__CompositorInstance__Listener.getCPtr(l));
  }
