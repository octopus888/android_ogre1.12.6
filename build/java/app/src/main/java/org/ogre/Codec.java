...
public class Codec {
  ...
  public static SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_std__string_Ogre__Codec_p_t_t getCodecIterator() {
    return new SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_std__string_Ogre__Codec_p_t_t(OgreJNI.Codec_getCodecIterator(), true);
  }
