...
public class OverlayManager extends ScriptLoader {
  ...
  public void parseScript(DataStreamPtr stream, String groupName) {
    OgreOverlayJNI.OverlayManager_parseScript(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream, groupName);
  }
  ...
  public void addOverlay(Overlay overlay) {
    OgreOverlayJNI.OverlayManager_addOverlay(swigCPtr, this, Overlay.getCPtr(overlay), overlay);
  }
  ...
  public SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__Overlay_p_t_t getOverlayIterator() {
    return new SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__Overlay_p_t_t(OgreOverlayJNI.OverlayManager_getOverlayIterator(swigCPtr, this), true);
  }
  ...
  public void setPixelRatio(float ratio) {
    OgreOverlayJNI.OverlayManager_setPixelRatio(swigCPtr, this, ratio);
  }

  public float getPixelRatio() {
    return OgreOverlayJNI.OverlayManager_getPixelRatio(swigCPtr, this);
  }
  ...
  public SWIGTYPE_p_std__mapT_std__string_Ogre__OverlayElementFactory_p_t getOverlayElementFactoryMap() {
    return new SWIGTYPE_p_std__mapT_std__string_Ogre__OverlayElementFactory_p_t(OgreOverlayJNI.OverlayManager_getOverlayElementFactoryMap(swigCPtr, this), false);
  }
  ...
  public SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__OverlayElement_p_t_t getTemplateIterator() {
    return new SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__OverlayElement_p_t_t(OgreOverlayJNI.OverlayManager_getTemplateIterator(swigCPtr, this), true);
  }
