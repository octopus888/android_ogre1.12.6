...
public class MeshPtr {
  ...
  public MeshPtr(SWIGTYPE_p_std__nullptr_t arg0) {
    this(OgreJNI.new_MeshPtr__SWIG_0(SWIGTYPE_p_std__nullptr_t.getCPtr(arg0)), true);
  }
  ...
  public void setSharedBlendIndexToBoneIndexMap(SWIGTYPE_p_std__vectorT_unsigned_short_t value) {
    OgreJNI.MeshPtr_sharedBlendIndexToBoneIndexMap_set(swigCPtr, this, SWIGTYPE_p_std__vectorT_unsigned_short_t.getCPtr(value));
  }
  ...
  public SWIGTYPE_p_Ogre__MapIteratorT_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t_t getBoneAssignmentIterator() {
    return new SWIGTYPE_p_Ogre__MapIteratorT_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t_t(OgreJNI.MeshPtr_getBoneAssignmentIterator(swigCPtr, this), true);
  }

  public SWIGTYPE_p_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t getBoneAssignments() {
    return new SWIGTYPE_p_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t(OgreJNI.MeshPtr_getBoneAssignments(swigCPtr, this), false);
  }
  ...
  public int _rationaliseBoneAssignments(long vertexCount, SWIGTYPE_p_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t assignments) {
    return OgreJNI.MeshPtr__rationaliseBoneAssignments(swigCPtr, this, vertexCount, SWIGTYPE_p_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t.getCPtr(assignments));
  }
  ...
  public void prepareMatricesForVertexBlend(SWIGTYPE_p_p_Ogre__Affine3 blendMatrices, Affine3 boneMatrices, SWIGTYPE_p_std__vectorT_unsigned_short_t indexMap) {
    OgreJNI.MeshPtr_prepareMatricesForVertexBlend(swigCPtr, this, SWIGTYPE_p_p_Ogre__Affine3.getCPtr(blendMatrices), Affine3.getCPtr(boneMatrices), boneMatrices, SWIGTYPE_p_std__vectorT_unsigned_short_t.getCPtr(indexMap));
  }
  ...
  public void softwareVertexBlend(VertexData sourceVertexData, VertexData targetVertexData, SWIGTYPE_p_p_Ogre__Affine3 blendMatrices, long numMatrices, boolean blendNormals) {
    OgreJNI.MeshPtr_softwareVertexBlend(swigCPtr, this, VertexData.getCPtr(sourceVertexData), sourceVertexData, VertexData.getCPtr(targetVertexData), targetVertexData, SWIGTYPE_p_p_Ogre__Affine3.getCPtr(blendMatrices), numMatrices, blendNormals);
  }
  ...
  public void softwareVertexPoseBlend(float weight, SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_t vertexOffsetMap, SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_t normalsMap, VertexData targetVertexData) {
    OgreJNI.MeshPtr_softwareVertexPoseBlend(swigCPtr, this, weight, SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_t.getCPtr(vertexOffsetMap), SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_t.getCPtr(normalsMap), VertexData.getCPtr(targetVertexData), targetVertexData);
  }

  public SWIGTYPE_p_std__unordered_mapT_std__string_unsigned_short_t getSubMeshNameMap() {
    return new SWIGTYPE_p_std__unordered_mapT_std__string_unsigned_short_t(OgreJNI.MeshPtr_getSubMeshNameMap(swigCPtr, this), false);
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__ParameterDef_t getParameters() {
    return new SWIGTYPE_p_std__vectorT_Ogre__ParameterDef_t(OgreJNI.MeshPtr_getParameters(swigCPtr, this), false);
  }
  ...
  public void setParameterList(NameValuePairList paramList) {
    OgreJNI.MeshPtr_setParameterList(swigCPtr, this, NameValuePairList.getCPtr(paramList), paramList);
  }
