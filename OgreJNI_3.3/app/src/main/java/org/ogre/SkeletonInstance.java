...
public class SkeletonInstance extends Skeleton {
  ...
  public SWIGTYPE_p_Ogre__ConstVectorIteratorT_std__vectorT_Ogre__LinkedSkeletonAnimationSource_t_t getLinkedSkeletonAnimationSourceIterator() {
    return new SWIGTYPE_p_Ogre__ConstVectorIteratorT_std__vectorT_Ogre__LinkedSkeletonAnimationSource_t_t(OgreJNI.SkeletonInstance_getLinkedSkeletonAnimationSourceIterator(swigCPtr, this), true);
  }
