...
public class Camera extends Frustum {
  ...
  static public class Listener {
    ...
    public Listener() {
      ...
      OgreJNI.Camera_Listener_director_connect(this, swigCPtr, swigCMemOwn, true);
    }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__Plane_t getWindowPlanes() {
    return new SWIGTYPE_p_std__vectorT_Ogre__Plane_t(OgreJNI.Camera_getWindowPlanes(swigCPtr, this), false);
  }
  ...
  public void forwardIntersect(Plane worldPlane, SWIGTYPE_p_std__vectorT_Ogre__VectorT_4_Ogre__Real_t_t intersect3d) {
    OgreJNI.Camera_forwardIntersect(swigCPtr, this, Plane.getCPtr(worldPlane), worldPlane, SWIGTYPE_p_std__vectorT_Ogre__VectorT_4_Ogre__Real_t_t.getCPtr(intersect3d));
  }
  ...
  public SWIGTYPE_p_a_8__Ogre__VectorT_3_float_t getWorldSpaceCorners() {
    return new SWIGTYPE_p_a_8__Ogre__VectorT_3_float_t(OgreJNI.Camera_getWorldSpaceCorners(swigCPtr, this), false);
  }
  ...
  public Affine3 getViewMatrix() {
    return new Affine3(OgreJNI.Camera_getViewMatrix__SWIG_0(swigCPtr, this), false);
  }

  public Affine3 getViewMatrix(boolean ownFrustumOnly) {
    return new Affine3(OgreJNI.Camera_getViewMatrix__SWIG_1(swigCPtr, this, ownFrustumOnly), false);
  }
