...
public class MaterialManager extends ResourceManager {
  ...
  public MaterialPtr create(String name, String group, boolean isManual, ManualResourceLoader loader, NameValuePairList createParams) {
    return new MaterialPtr(OgreJNI.MaterialManager_create__SWIG_0(swigCPtr, this, name, group, isManual, ManualResourceLoader.getCPtr(loader), loader, NameValuePairList.getCPtr(createParams), createParams), true);
  }
  ...
  public void parseScript(DataStreamPtr stream, String groupName) {
    OgreJNI.MaterialManager_parseScript(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream, groupName);
  }
