...
public class InstanceManager {
  ...
  public SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_std__string_std__vectorT_Ogre__InstanceBatch_p_t_t_t getInstanceBatchMapIterator() {
    return new SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_std__string_std__vectorT_Ogre__InstanceBatch_p_t_t_t(OgreJNI.InstanceManager_getInstanceBatchMapIterator(swigCPtr, this), true);
  }
  ...
  public SWIGTYPE_p_Ogre__ConstVectorIteratorT_std__vectorT_Ogre__InstanceBatch_p_t_t getInstanceBatchIterator(String materialName) {
    return new SWIGTYPE_p_Ogre__ConstVectorIteratorT_std__vectorT_Ogre__InstanceBatch_p_t_t(OgreJNI.InstanceManager_getInstanceBatchIterator(swigCPtr, this, materialName), true);
  }
