...
public class StaticGeometry {
  ...
  static public class QueuedSubMesh {
    ...
    public void setGeometryLodList(SWIGTYPE_p_std__vectorT_Ogre__StaticGeometry__SubMeshLodGeometryLink_t value) {
      OgreJNI.StaticGeometry_QueuedSubMesh_geometryLodList_set(swigCPtr, this, SWIGTYPE_p_std__vectorT_Ogre__StaticGeometry__SubMeshLodGeometryLink_t.getCPtr(value));
    }
  
    public SWIGTYPE_p_std__vectorT_Ogre__StaticGeometry__SubMeshLodGeometryLink_t getGeometryLodList() {
      long cPtr = OgreJNI.StaticGeometry_QueuedSubMesh_geometryLodList_get(swigCPtr, this);
      return (cPtr == 0) ? null : new SWIGTYPE_p_std__vectorT_Ogre__StaticGeometry__SubMeshLodGeometryLink_t(cPtr, false);
    }
  ...
  static public class MaterialBucket {
    ...
    public SWIGTYPE_p_std__vectorT_Ogre__StaticGeometry__GeometryBucket_p_t getGeometryList() {
      return new SWIGTYPE_p_std__vectorT_Ogre__StaticGeometry__GeometryBucket_p_t(OgreJNI.StaticGeometry_MaterialBucket_getGeometryList(swigCPtr, this), false);
    }
  
    public SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__StaticGeometry__GeometryBucket_p_t_t getGeometryIterator() {
      return new SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__StaticGeometry__GeometryBucket_p_t_t(OgreJNI.StaticGeometry_MaterialBucket_getGeometryIterator(swigCPtr, this), true);
    }
  ...
  static public class LODBucket {
    ...
    public SWIGTYPE_p_std__mapT_std__string_Ogre__StaticGeometry__MaterialBucket_p_t getMaterialBuckets() {
      return new SWIGTYPE_p_std__mapT_std__string_Ogre__StaticGeometry__MaterialBucket_p_t(OgreJNI.StaticGeometry_LODBucket_getMaterialBuckets(swigCPtr, this), false);
    }
  
    public SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__StaticGeometry__MaterialBucket_p_t_t getMaterialIterator() {
      return new SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__StaticGeometry__MaterialBucket_p_t_t(OgreJNI.StaticGeometry_LODBucket_getMaterialIterator(swigCPtr, this), true);
    }
    ...
    public SWIGTYPE_p_std__vectorT_Ogre__ShadowRenderable_p_t getShadowRenderableList() {
      return new SWIGTYPE_p_std__vectorT_Ogre__ShadowRenderable_p_t(OgreJNI.StaticGeometry_LODBucket_getShadowRenderableList(swigCPtr, this), false);
    }
  ...
  static public class Region extends MovableObject {
    ...
    public SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__StaticGeometry__LODBucket_p_t_t getLODIterator() {
      return new SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__StaticGeometry__LODBucket_p_t_t(OgreJNI.StaticGeometry_Region_getLODIterator(swigCPtr, this), true);
    }
  
    public SWIGTYPE_p_std__vectorT_Ogre__StaticGeometry__LODBucket_p_t getLODBuckets() {
      return new SWIGTYPE_p_std__vectorT_Ogre__StaticGeometry__LODBucket_p_t(OgreJNI.StaticGeometry_Region_getLODBuckets(swigCPtr, this), false);
    }
    ...
    public SWIGTYPE_p_std__vectorT_Ogre__ShadowRenderable_p_t getShadowVolumeRenderableList(ShadowTechnique shadowTechnique, Light light, HardwareIndexBufferPtr indexBuffer, SWIGTYPE_p_size_t indexBufferUsedSize, boolean extrudeVertices, float extrusionDistance, long flags) {
      return new SWIGTYPE_p_std__vectorT_Ogre__ShadowRenderable_p_t(OgreJNI.StaticGeometry_Region_getShadowVolumeRenderableList__SWIG_0(swigCPtr, this, shadowTechnique.swigValue(), Light.getCPtr(light), light, HardwareIndexBufferPtr.getCPtr(indexBuffer), indexBuffer, SWIGTYPE_p_size_t.getCPtr(indexBufferUsedSize), extrudeVertices, extrusionDistance, flags), false);
    }
    ...
    public SWIGTYPE_p_std__vectorT_Ogre__ShadowRenderable_p_t getShadowVolumeRenderableList(ShadowTechnique shadowTechnique, Light light, HardwareIndexBufferPtr indexBuffer, SWIGTYPE_p_size_t indexBufferUsedSize, boolean extrudeVertices, float extrusionDistance) {
      return new SWIGTYPE_p_std__vectorT_Ogre__ShadowRenderable_p_t(OgreJNI.StaticGeometry_Region_getShadowVolumeRenderableList__SWIG_1(swigCPtr, this, shadowTechnique.swigValue(), Light.getCPtr(light), light, HardwareIndexBufferPtr.getCPtr(indexBuffer), indexBuffer, SWIGTYPE_p_size_t.getCPtr(indexBufferUsedSize), extrudeVertices, extrusionDistance), false);
    }
  ...
  public SWIGTYPE_p_std__mapT_unsigned_int_Ogre__StaticGeometry__Region_p_t getRegions() {
    return new SWIGTYPE_p_std__mapT_unsigned_int_Ogre__StaticGeometry__Region_p_t(OgreJNI.StaticGeometry_getRegions(swigCPtr, this), false);
  }

  public SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_unsigned_int_Ogre__StaticGeometry__Region_p_t_t getRegionIterator() {
    return new SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_unsigned_int_Ogre__StaticGeometry__Region_p_t_t(OgreJNI.StaticGeometry_getRegionIterator(swigCPtr, this), true);
  }
