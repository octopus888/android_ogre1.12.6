...
public class PatchMeshPtr {
  ...
  public SWIGTYPE_p_Ogre__MapIteratorT_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t_t getBoneAssignmentIterator() {
    return new SWIGTYPE_p_Ogre__MapIteratorT_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t_t(OgreJNI.PatchMeshPtr_getBoneAssignmentIterator(swigCPtr, this), true);
  }
  ...
  public void setLodStrategy(SWIGTYPE_p_Ogre__LodStrategy lodStrategy) {
    OgreJNI.PatchMeshPtr_setLodStrategy(swigCPtr, this, SWIGTYPE_p_Ogre__LodStrategy.getCPtr(lodStrategy));
  }
