...
public class ArchiveManager {
  ...
  public SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__Archive_p_t_t getArchiveIterator() {
    return new SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__Archive_p_t_t(OgreJNI.ArchiveManager_getArchiveIterator(swigCPtr, this), true);
  }
