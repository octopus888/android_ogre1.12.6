...
public class OverlayContainer extends OverlayElement {
  ...
  public SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__OverlayElement_p_t_t getChildIterator() {
    return new SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__OverlayElement_p_t_t(OgreOverlayJNI.OverlayContainer_getChildIterator(swigCPtr, this), true);
  }

  public SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__OverlayContainer_p_t_t getChildContainerIterator() {
    return new SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__OverlayContainer_p_t_t(OgreOverlayJNI.OverlayContainer_getChildContainerIterator(swigCPtr, this), true);
  }
