...
public class ManualObject extends MovableObject {
  ...
  public void begin(MaterialPtr mat, RenderOperation.OperationType opType) {
    OgreJNI.ManualObject_begin__SWIG_3(swigCPtr, this, MaterialPtr.getCPtr(mat), mat, opType.swigValue());
  }

  public void begin(MaterialPtr mat) {
    OgreJNI.ManualObject_begin__SWIG_4(swigCPtr, this, MaterialPtr.getCPtr(mat), mat);
  }
  ...
  public void setMaterial(long subIndex, MaterialPtr mat) {
    OgreJNI.ManualObject_setMaterial(swigCPtr, this, subIndex, MaterialPtr.getCPtr(mat), mat);
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__ShadowRenderable_p_t getShadowVolumeRenderableList(ShadowTechnique shadowTechnique, Light light, HardwareIndexBufferPtr indexBuffer, SWIGTYPE_p_size_t indexBufferUsedSize, boolean extrudeVertices, float extrusionDist, long flags) {
    return new SWIGTYPE_p_std__vectorT_Ogre__ShadowRenderable_p_t(OgreJNI.ManualObject_getShadowVolumeRenderableList__SWIG_0(swigCPtr, this, shadowTechnique.swigValue(), Light.getCPtr(light), light, HardwareIndexBufferPtr.getCPtr(indexBuffer), indexBuffer, SWIGTYPE_p_size_t.getCPtr(indexBufferUsedSize), extrudeVertices, extrusionDist, flags), false);
  }
  ...
  static public class ManualObjectSection extends Renderable {
    ...
    public ManualObjectSection(ManualObject parent, MaterialPtr mat, RenderOperation.OperationType opType) {
      this(OgreJNI.new_ManualObject_ManualObjectSection__SWIG_2(ManualObject.getCPtr(parent), parent, MaterialPtr.getCPtr(mat), mat, opType.swigValue()), true);
    }
    ...
    public void setMaterial(MaterialPtr mat) {
      OgreJNI.ManualObject_ManualObjectSection_setMaterial(swigCPtr, this, MaterialPtr.getCPtr(mat), mat);
    }
    ...
    public void convertToSubMesh(SubMesh sm) {
      OgreJNI.ManualObject_ManualObjectSection_convertToSubMesh(swigCPtr, this, SubMesh.getCPtr(sm), sm);
    }
