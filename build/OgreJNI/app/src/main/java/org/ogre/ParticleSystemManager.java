...
public class ParticleSystemManager extends ScriptLoader {
  ...
  public void parseScript(DataStreamPtr stream, String groupName) {
    OgreJNI.ParticleSystemManager_parseScript(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream, groupName);
  }
  ...
  public SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__ParticleAffectorFactory_p_t_t getAffectorFactoryIterator() {
    return new SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__ParticleAffectorFactory_p_t_t(OgreJNI.ParticleSystemManager_getAffectorFactoryIterator(swigCPtr, this), true);
  }

  public SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__ParticleEmitterFactory_p_t_t getEmitterFactoryIterator() {
    return new SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__ParticleEmitterFactory_p_t_t(OgreJNI.ParticleSystemManager_getEmitterFactoryIterator(swigCPtr, this), true);
  }

  public SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__ParticleSystemRendererFactory_p_t_t getRendererFactoryIterator() {
    return new SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__ParticleSystemRendererFactory_p_t_t(OgreJNI.ParticleSystemManager_getRendererFactoryIterator(swigCPtr, this), true);
  }

  public SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__ParticleSystem_p_t_t getTemplateIterator() {
    return new SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__ParticleSystem_p_t_t(OgreJNI.ParticleSystemManager_getTemplateIterator(swigCPtr, this), true);
  }
